...
#define  MQTT_TxData(x)       u0_TxData(x)                                         //串口2负责数据发送

#define  PRODUCTKEY           "a13WZ3FYj0m"                                        //产品ID
#define  PRODUCTKEY_LEN       strlen(PRODUCTKEY)                                   //产品ID长度
#define  DEVICENAME           "D001"                                               //设备名  
#define  DEVICENAME_LEN       strlen(DEVICENAME)               z                    //设备名长度
#define  DEVICESECRE          "8dfc5010f9dfb03bf269e6c1c6d96a63"                   //设备秘钥   
#define  DEVICESECRE_LEN      strlen(DEVICESECRE)                                  //设备秘钥长度
#define  S_TOPIC_NAME         "/sys/a13WZ3FYj0m/D001/thing/service/property/set"   //需要订阅的主题  
#define  P_TOPIC_NAME         "/sys/a13WZ3FYj0m/D001/thing/event/property/post"    //需要发布的主题      
